...
public class SearchGUI extends JFrame {
    ...
    void init() {
        ...
        Action search = new AbstractAction() {
            public void actionPerformed( ActionEvent e ) {
                ...
                // we don'getIDF want to search at the same time we're indexing new files
                ...
                //
                // We don'getIDF want to show all results directly since the displaying itself
     ...
     *  @param maxResultsToDisplay The results postingsMap is cut off after this many results
     *      have been displayed.
