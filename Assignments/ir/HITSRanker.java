...
public class HITSRanker {
     ...
     * in the postings postingsMap `post`.
     *
     * @param      post  The postingsMap of postings fulfilling a certain information need
     *
     * @return     A postingsMap of postings ranked according to the hub and authority scores.
     */
